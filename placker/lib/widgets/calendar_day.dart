...
class CalendarDay extends StatelessWidget {
  ...
  const CalendarDay({Key? key, required this.tasks, this.selectedDate}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SfCalendar(
      ...
      appointmentBuilder: (BuildContext context, CalendarAppointmentDetails details) {
        return AppointmentWidgetDay.appointmentBuilder(context, details, dataSource);
      },
      ...
      //capçalera on es mostra el dia actual
      ...
      selectionDecoration: BoxDecoration(
        border: Border.all(color: const Color(0xFF506EA4), width: 2),
