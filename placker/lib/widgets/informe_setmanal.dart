          ...
          children: [
            Consumer<TasksService>(
              builder: (context, tasksService, child) {
                ...
                final controller = PageController(initialPage: currentWeekIndex);
                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('Temps total de les tasques: ${convertTimeToString(taskDurationFinal)}', style: const TextStyle(color: Color(0xff506EA4), fontSize: 18)),
                              Text('Temps total invertit: ${convertTimeToString(tempsTotalFinal)}', style: const TextStyle(color: Color(0xff506EA4), fontSize: 18)),
                              Text('Temps de focus: ${convertTimeToString(tempsFocusFinal)}', style: const TextStyle(color: Color(0xff506EA4), fontSize: 18)),
                              Text('Temps de pausa: ${convertTimeToString(tempsPausaFinal)}', style: const TextStyle(color: Color(0xff506EA4), fontSize: 18)),
      ...
      child: SizedBox(
        ...
        child: BarChart(
          BarChartData(
            ...
            maxY: taskDurations.reduce((a, b) => a > b ? a : b),
