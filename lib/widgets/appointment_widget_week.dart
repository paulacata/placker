...
//per crear l'appointment al calendari setmanal
class AppointmentWidgetWeek {
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (taskPrioritat.color != null && taskPrioritat.color != '')
                                  CircleAvatar(radius: 6, backgroundColor: Color(int.tryParse(taskPrioritat.color!) ?? 0xFFFFFFFF))
                                else
                                  Container()
                              ]
                            )
